/*******************************************************************************
 * Taken from tlx - http://panthema.net/tlx
 *
...
#ifndef D_ARY_ADDRESSABLE_INT_HEAP_HEADER
#define D_ARY_ADDRESSABLE_INT_HEAP_HEADER
...
#endif // !D_ARY_ADDRESSABLE_INT_HEAP_HEADER
